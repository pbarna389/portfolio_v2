			...
			<div className={fadeout ? 'modal fadeout' : fadeIn ? 'modal shown' : 'modal'}>
				...
				<div className="btn-wrapper">
					<button type="button" className="btn-prev" onClick={() => prevPic()}>
						<Arrow style={{ height: '2rem', width: '2rem', rotate: '180deg' }} />
					</button>
					<button type="button" className="btn-next" onClick={() => nextPic()}>
						<Arrow style={{ height: '2rem', width: '2rem' }} />
					</button>
				</div>
				{selectedProject && (
					<>
				...
				<button type="button" className="closeModal btn" onClick={() => handleClick()}>
					Close
				</button>
			</div>
		</div>
